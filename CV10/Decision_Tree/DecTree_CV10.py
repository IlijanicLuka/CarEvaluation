...
def DecTreeRegCV(parameters, X_train,y_train,X_test, y_test):
    ...
    print("###################################################################")
    print("# Results from CV10 Cross Validation Using Multiple Metric")
    print("###################################################################")
    print("All Scores From CV10 = {}".format(cvmodel))
    file1.write("###############################################################\n")
...
while True:
    ...
    test = DecTreeRegCV(Param,X_train,y_train, X_test, y_test)
    k+=1
    if (test > 0.999):
